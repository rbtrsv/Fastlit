...
# endpoint = 'http://localhost:8000/ml_models/health_insurance/predict'
endpoint = 'http://host.docker.internal:8000/ml_models/health_insurance/predict' # Specify this path for Dockerization to work
